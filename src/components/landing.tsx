...
function Landing() {
    return (
        <section className="dark:bg-gray-800 dark:text-gray-100 mt-60 mb-60">
            <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-6xl">
                ...
                <p className="px-8 mt-8 mb-12 text-2xl text-grey leading-relaxed">A recent Electrical Engineering graduate with a minor in Mathematics.
