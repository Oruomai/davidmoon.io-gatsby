...
export const Contact = () => {
    return (
        <section id="contact" className="text-center px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 mb-20 mt-20 contact_section">
